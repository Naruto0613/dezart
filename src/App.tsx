...
const TitleSlide = ({ isActive }: SlideProps) => (
  <div className="flex flex-col items-center justify-center h-full text-center px-4 relative">
    ...
    <div className="absolute inset-0 bg-linear-to-t from-[#1A0F05] via-transparent to-transparent" />
  </div>
);
...
const FocusSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative">
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-[#D2691E]/5 rounded-full blur-3xl pointer-events-none" />
    ...
    <div className="text-center mb-10 relative z-10">
      ...
      <div className="h-0.5 w-24 bg-linear-to-r from-transparent via-[#D2691E] to-transparent mx-auto mt-4" />
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
      {[
        ...
        >
          ...
          {/* Accent bottom line */}
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-[#D2691E]/20 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
        </motion.div>
      ))}
    </div>
  </div>
...
const GoalsObjectivesSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    ...
    <div className="absolute top-10 left-10 w-96 h-96 bg-emerald-500/3 rounded-full blur-3xl pointer-events-none" />
    <div className="absolute bottom-10 right-10 w-96 h-96 bg-orange-500/3 rounded-full blur-3xl pointer-events-none" />
    ...
    <div className="text-center mb-10 relative z-10">
      ...
      <div className="h-0.5 w-24 bg-linear-to-r from-transparent via-emerald-500 to-transparent mx-auto mt-4" />
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 z-10">
      {[
        ...
        <motion.div
          ...
          className={`group bg-black/60 border-2 ${item.color} rounded-[2.5rem] p-8 flex flex-col justify-between relative overflow-hidden h-122.5 transition-all duration-300 backdrop-blur-md shadow-2xl`}
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-0 h-44 overflow-hidden rounded-t-[2.2rem] border-b-2 border-white/10">
            <img
              ...
              alt={item.title}
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#0d0703] via-transparent to-transparent opacity-90" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 z-10">
      {[
        ...
        <motion.div
          ...
          className={`group relative h-95 rounded-[2.5rem] overflow-hidden border ${item.accent} bg-black/40 hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all duration-500`}
        >
          <img
            src={item.img}
            ...
            alt=""
          />
          <div className="absolute inset-0 bg-linear-to-t from-[#120701] via-[#120701]/60 to-transparent p-6 flex flex-col justify-end">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 z-10">
      {[
        ...
        <motion.div
          ...
          className={`group relative h-105 rounded-[2.5rem] overflow-hidden border ${step.accent} bg-black/50 hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all duration-500`}
        >
          ...
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt={step.title}
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#120701] via-[#120701]/80 to-[#120701]/30" />
          </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 z-10">
      {[
        ...
        <motion.div
          ...
          className={`${card.color} ${card.border} border-2 rounded-[2.5rem] p-8 flex flex-col justify-between group hover:scale-[1.02] transition-all duration-300 backdrop-blur-xl relative overflow-hidden h-85`}
        >
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-xs text-[#F5DEB3]/70 leading-relaxed font-light">
            SIA бол зөвхөн уриа лоозон биш, сургууль, залуучуудын оролцоог бодит
            эдийн засгийн цикл дээр суурилсан эко орчин болгон сэргээдэг
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 z-10">
      {[
        ...
        <motion.div
          ...
          animate={isActive ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: i * 0.15 }}
          className={`${col.bg} border-2 ${col.color} p-8 rounded-[2.5rem] backdrop-blur-md hover:border-white/20 transition-all flex flex-col justify-between h-105`}
        >
          <div>
    ...
    <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center z-10">
        <motion.div
          ...
          animate={isActive ? { opacity: 1, scale: 1 } : {}}
          className="h-112.5 w-full relative flex items-center justify-center p-8 bg-black/20 rounded-[3rem] backdrop-blur-md border border-white/5"
        >
...
const VisionSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative">
    ...
    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-emerald-500/3 rounded-full blur-3xl pointer-events-none" />
      ...
      {[
        ...
        >
          <div className="h-44 bg-black/45 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-[#120b05] via-transparent to-transparent" />
...
const FutureTasksSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    ...
    {/* Ambient lighting */}
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-[#D2691E]/5 rounded-full blur-3xl pointer-events-none" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-5 mb-6">
            <div className="p-4 bg-linear-to-br from-[#D2691E] to-[#CD853F] rounded-[1.25rem] text-white shadow-xl shadow-[#D2691E]/20">
              <RefreshCw
                size={28}
          ...
          <p className="text-base text-[#F5DEB3]/85 font-light leading-relaxed max-w-xl">
            ...
            суулгац худалдан авч тарина. Энэхүү цикл нь санхүүгийн болон байгаль
            орчны хувьд тасралтгүй, өөрөө өөрийгөө тэтгэх мөчлөг юм.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8 relative">
          {[
            ...
            <div key={i} className="relative">
              <div
                className={`p-4 rounded-2xl border ${step.border} ${step.bg} flex flex-col justify-between h-28 group-hover:bg-white/2 transition-colors`}
              >
      ...
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/2 rounded-full blur-2xl pointer-events-none group-hover:bg-red-500/5 transition-all" />
      ...
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/2 rounded-full blur-2xl pointer-events-none group-hover:bg-emerald-500/5 transition-all" />
        ...
        <div>
          ...
          <p className="text-sm text-[#F5DEB3]/70 font-light leading-relaxed">
            ...
            <span className="font-bold text-emerald-400">
              1,000 чацарганы болон орон нутагт дасан зохицох чадвартай моддийг
            </span>{" "}
        ...
        <div className="mt-6">
          ...
          <div className="w-full h-1.5 bg-black/40 rounded-full overflow-hidden p-0.5">
            <div
              className="h-full bg-linear-to-r from-[#D2691E] to-emerald-500 rounded-full animate-pulse"
              style={{ width: "100%" }}
            />
          </div>
        </div>
      ...
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/2 rounded-full blur-2xl pointer-events-none group-hover:bg-amber-500/5 transition-all" />
      ...
      >
        ...
        <p className="text-[10px] text-[#F5DEB3]/60 max-w-45 mt-2 leading-relaxed">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      >
        ...
        <p className="text-lg text-[#F5DEB3]/80 leading-relaxed font-light">
          Сургуулийн сурагчдад эко систем, ургамал зүйн үндэс, хог хаягдлын зөв
          ангиллын боловсролыг хувийн хурцадмал бус хөгжилтэй, тоглоомжсон
        ...
        <div className="space-y-3.5 pt-2">
          {[
            ...
            <div
              key={i}
              className="flex items-start gap-4 bg-white/2 border border-white/5 px-5 py-3.5 rounded-2xl hover:bg-[#4CAF50]/10 hover:border-[#4CAF50]/20 transition-colors"
            >
      ...
      >
        ...
        <div className="relative z-10 bg-[#160d05]/95 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden aspect-4/3 flex flex-col backdrop-blur-2xl">
          {/* Browser Tab/URL Bar */}
          <div className="bg-white/4 px-5 py-4 flex items-center gap-4 border-b border-white/5 shrink-0">
          ...
          <div className="p-6 flex-1 flex gap-4 bg-linear-to-b from-[#140b04] to-[#121c13] overflow-hidden select-none relative">
            ...
            <div className="flex-1 flex flex-col gap-4 overflow-hidden relative">
              ...
              <div className="p-4 bg-white/2 border border-white/5 rounded-2xl">
                ...
                <p className="text-[10px] text-[#F5DEB3]/60 mt-1 lines-clamp-1">
                  Элсний нүүдлийг ямар бүтэцтэй ургамал хамгийн сайн хазаарладаг
                  вэ?
                </p>
              </div>

              {/* Ecosystem Web / Food cycle simulation built beautifully (STUNNING GRAPHIC DETAILS) */}
              <div className="bg-black/30 border border-white/5 rounded-2xl p-3 flex flex-col items-center justify-center min-h-22.5 relative overflow-hidden">
              ...
              <div className="bg-black/35 rounded-2xl p-4 border border-white/5 space-y-2 relative">
                ...
                <div className="space-y-1.5 pt-1">
                  {/* Option A */}
                  <div className="flex items-center justify-between p-2 rounded-xl bg-white/1 border border-white/5 text-[10px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        {comps.map((comp, i) => (
          <motion.div
            ...
            className="group relative h-48 rounded-4x1 overflow-hidden border border-white/5 hover:border-[#D2691E]/40 bg-black/40 transition-all cursor-pointer shadow-xl flex flex-col justify-between p-6"
          >
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
      ...
      >
        ...
        <p className="text-[#F4A460] font-medium border-b border-[#D2691E]/30 pb-4">
          Сар бүр зохион байгуулагдах тэмцээн бүрийн ялагч анги болон сурагчдад:
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-5 relative z-10">
        {causes.map((item, idx) => (
          <motion.div
            ...
            animate={isActive ? { opacity: 1, y: 0 } : {}}
            transition={{ delay: idx * 0.1, duration: 0.5 }}
            className="bg-[#1c1109]/70 backdrop-blur-md p-6 rounded-4x1 border border-white/5 hover:border-[#D2691E]/30 hover:bg-[#1b120c]/90 transition-all duration-300 group flex flex-col justify-between h-80 relative"
          >
...
const SolutionsSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    ...
    {/* Ambient lighting */}
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-emerald-500/4 rounded-full blur-3xl pointer-events-none" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
      {[
        ...
        <motion.div
          ...
          className="bg-[#101912]/50 backdrop-blur-md p-6 rounded-4x1 border border-white/5 hover:border-emerald-500/30 hover:bg-[#101b13]/80 transition-all duration-300 group flex flex-col justify-between h-56 relative overflow-hidden"
        >
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
      ...
      >
        ...
        <p className="text-xl text-[#F5DEB3]/80 leading-relaxed font-light">
          Бид өөрсдийн боловсруулан хэрэгжүүлсэн "Ногоон Ирээдүй" төслөө шийдвэр
          гаргах хамгийн дээд түвшинд танилцуулж, залуучуудын дуу хоолойг
          бодлогын түвшинд хүргэдэг.
        </p>
        <div className="space-y-4">
          {[
            {
      ...
      >
        ...
        {/* New Goal Badge */}
        <div className="absolute left-0 -bottom-10 bg-[#1A0F05] p-6 rounded-3xl shadow-2xl z-20 border border-white/10 max-w-50">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
      {[
        ...
        <motion.div
          ...
          animate={isActive ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: i * 0.15, type: "spring", stiffness: 90 }}
          className={`${item.bg} border-2 p-8 rounded-[2.5rem] backdrop-blur-md hover:scale-[1.02] transition-all duration-300 flex flex-col justify-between h-75`}
        >
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[9px] font-mono font-bold tracking-widest text-[#F5DEB3]/30">
                {item.target}
              </span>
            </div>
            ...
            <p className="text-xs text-[#F5DEB3]/75 leading-relaxed font-light">
              {item.desc}
            </p>
          </div>
