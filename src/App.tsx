...
const TeammatesSlide = ({ isActive }: SlideProps) => {
  const teams = [
    {
      ...
      members: ["Мишээл", "Удвал", "Анар-Эрдэнэ", "Анхболор", "Буянтөгс", "Бат-Эрдэнэ", "Дорж"]
    },
    {
      name: "Илтгэлийн Баг",
      members: ["Сэцэн", "Наранбадрах", "Ууганбаяр", "Түвшинжаргал", "Арвин-Erdene", "Цэцэг", "Бат"]
    },
    {
      name: "Судалгааны Баг",
      members: ["Анундари", "Анужин", "Мөнгөнзаяа", "Оюунсувд", "Гэрэл", "Төгөлдөр", "Очир"]
    }
  ];
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80')] bg-cover opacity-[0.08] pointer-events-none" />
      <motion.h2 
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
      {[
        ...
        >
          ...
          <div>
            <span className="text-[10px] text-[#F5DEB3]/50 font-mono uppercase tracking-wider">{item.subtitle}</span>
...
const GoalsObjectivesSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?auto=format&fit=crop&q=80')] bg-cover opacity-[0.14] pointer-events-none" />
      ...
      >
        ...
        <div className="space-y-6 relative z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="text-[10px] text-orange-500/60 font-mono font-bold uppercase tracking-wider block">MAIN GOAL</span>
              <h3 className="text-2xl font-black text-white uppercase tracking-tight">ЗОРИЛГО</h3>
            </div>
          </div>

          <p className="text-lg text-[#F5DEB3]/90 font-light leading-relaxed">
            Хуванцар хаягдлыг дахин ашиглаж, бохирдлыг багасгаснаар хөрсний доройтолтой нутгийг сэргээж, цөлжилттэй тэмцэх, дэлхийн цөлжилт төдийгүй Монголын Говийг дахин амь оруулж, эрүүл, тогтвортой ирээдүйг цогцлоох.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 flex gap-6 text-[11px] font-mono font-bold text-orange-400 relative z-10">
          <div>🌎 GLOBAL TARGET: <span className="text-white">SDG 15</span></div>
          <div>🌱 FOCUS: <span className="text-[#4CAF50]">AFFORESTATION</span></div>
        </div>
      </motion.div>
      ...
      >
        <div className="space-y-6 relative z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="text-[10px] text-emerald-500/60 font-mono font-bold uppercase tracking-wider block">KEY OBJECTIVES</span>
              <h3 className="text-2xl font-black text-white uppercase tracking-tight">ЗОРИЛТУУД</h3>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: "Ангилал & Багасгалт", desc: "Сургууль доторх хуванцрын хаягдлыг бодитоор багасгаж хуваарилах.", target: "85%", icon: "🏫" },
              { title: "Ойр орчим цэвэрлэгээ", desc: "Сургуулийн ойр орчмын хуванцрын хаягдлыг системтэй цэвэрлэх.", target: "90%", icon: "🌳" },
              { title: "Дахин боловсруулалт", desc: "Цугларсан хаягдлыг үйлдвэрт тушааж эргэлтэд оруулах.", target: "100%", icon: "🔄" },
              { title: "Ойжуулах компанит ажил", desc: "Орлогоор Говийн бүсэд олноор чацарганы мод тарьж ургуулах.", target: "2000+ мод", icon: "🌱" }
            ].map((obj, i) => (
              <div 
                key={i} 
        ...
        <div className="mt-6 pt-6 border-t border-white/5 flex justify-between items-center text-[10px] font-mono text-emerald-400 relative z-10">
          ...
          <span className="text-[#4CAF50] font-bold">READY FOR DEPLOYMENT ➔</span>
        </div>
      </motion.div>
    </div>
  </div>
...
const IssuesChallengesSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?auto=format&fit=crop&q=80')] bg-cover opacity-[0.15] grayscale pointer-events-none" />
    ...
    >
      <span className="bg-red-500/10 border border-red-500/30 text-red-400 px-5 py-2 rounded-full text-xs font-mono tracking-widest uppercase mb-4 inline-block">ОНЦГОЙ БАЙДАЛ: СҮЙРЭЛ & СҮРДҮҮЛЭГ</span>
      <h2 className="text-4xl md:text-5xl font-black text-white hover:text-red-500 transition-colors uppercase tracking-widest leading-none">
        ТУЛГАМДАЖ БУЙ <span className="text-red-600 font-extrabold block md:inline">ҮНДЭСНИЙ АСУУДАЛ</span>
      </h2>
    </motion.div>
      ...
      {[
        {
          ...
          color: "border-red-500/30 hover:border-red-500 shadow-red-500/5 bg-red-950/20",
        ...
        },
        {
          ...
          color: "border-orange-500/30 hover:border-orange-500 shadow-orange-500/5 bg-orange-950/20",
        ...
        },
        {
          ...
          color: "border-amber-500/30 hover:border-amber-500 shadow-amber-500/5 bg-amber-950/20",
        ...
        },
        {
          ...
          color: "border-yellow-500/30 hover:border-yellow-500 shadow-yellow-500/5 bg-yellow-950/20",
        ...
        >
          ...
          <div className="z-10 mt-44 pt-4 flex flex-col justify-between flex-1">
            <div className="space-y-2">
              <div className={`${item.textColor} font-black text-3xl md:text-4xl font-mono tracking-tighter select-all leading-none`}>
                {item.num}
              </div>
            ...
            <div className="pt-2.5 border-t border-white/10 flex justify-between items-center text-[9px] font-mono text-[#F5DEB3]/40">
              <span className="tracking-widest uppercase font-bold text-[#F4A460]/70">ХАМТЫН ХЯНАЛТ</span>
              <span className="text-red-500 font-bold uppercase">SIA АНХААРУУЛГА</span>
            </div>
          </div>
        </motion.div>
      ))}
...
const ActivitiesSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542601906990-b4d3fb773b09?auto=format&fit=crop&q=80')] bg-cover opacity-[0.15] grayscale pointer-events-none" />
    <motion.div 
      initial={{ opacity: 0, y: -20 }}
      animate={isActive ? { opacity: 1, y: 0 } : {}}
    ...
    >
      <h2 className="text-4xl md:text-5xl font-black text-[#F4A460] uppercase tracking-widest pb-3 leading-tight">
        Бидний хэрэгжүүлсэн <span className="text-white">өмнө жилийн бодит алхмууд</span>
      </h2>
      <p className="text-[#F5DEB3]/60 text-xs font-light uppercase tracking-widest font-mono">Бодит ажил хэрэг хуурай үгнээс илүү хүчтэй</p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 z-10">
      {[
        ...
        { 
          ...
          label: "Ногоон Төгөл",
          badge: "AFFORESTAND",
          accent: "border-emerald-500/20 shadow-emerald-500/5 hover:border-emerald-400"
        },
        { 
          num: "03", 
          ...
          badge: "GLOCAL",
          accent: "border-purple-500/20 shadow-purple-500/5 hover:border-purple-400"
        },
        { 
          num: "04", 
          ...
          badge: "EDUCATION",
          accent: "border-amber-500/20 shadow-amber-500/5 hover:border-amber-400"
        }
      ].map((item, i) => (
        <motion.div
          key={i}
        ...
        >
          <img src={item.img} className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition-all duration-700 group-hover:scale-105" alt="" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#120701] via-[#120701]/60 to-transparent p-6 flex flex-col justify-end">
            <div className="flex justify-between items-center mb-3">
              <span className="text-4xl font-extrabold text-white/10 group-hover:text-[#F4A460]/20 transition-colors font-mono leading-none">{item.num}</span>
              <span className="text-[8px] font-mono tracking-widest bg-white/5 border border-white/10 px-2.5 py-1 rounded text-white/60">{item.badge}</span>
            </div>
            <div className="text-xs font-bold text-[#F4A460] uppercase tracking-wider mb-2 font-mono">{item.label}</div>
            <p className="text-sm text-[#F5DEB3]/90 leading-relaxed font-light">{item.text}</p>
          </div>
        </motion.div>
      ))}
    </div>
...
const ExpansionSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    ...
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80')] bg-cover opacity-[0.03] pointer-events-none z-0" />
    <motion.div 
      initial={{ opacity: 0, y: -20 }}
      animate={isActive ? { opacity: 1, y: 0 } : {}}
      className="text-center mb-10 z-10"
    >
      <span className="bg-[#D2691E]/10 border border-[#D2691E]/20 text-[#F4A460] px-4 py-1.5 rounded-full text-xs font-mono tracking-widest uppercase mb-3 inline-block">ИРЭЭДҮЙН ТӨЛӨВЛӨГӨӨ</span>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 z-10">
      {[
        { 
          ...
          accent: "border-orange-500/30 hover:border-orange-400 shadow-orange-500/5",
        ...
        { 
          ...
          accent: "border-emerald-500/30 hover:border-emerald-400 shadow-emerald-500/5",
        ...
        >
          ...
          <div className="absolute inset-0 p-8 flex flex-col justify-end z-10">
            <div className="flex justify-between items-center mb-4">
              <span className="text-5xl font-black font-mono text-white/20 group-hover:text-white/40 transition-colors leading-none">{step.phase}</span>
              <span className={`text-[9px] font-mono tracking-widest border px-3 py-1.5 rounded-full uppercase ${step.tagColor}`}>
                {step.badge}
              </span>
            </div>
...
const SDGSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden animate-fade-in">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542601906990-b4d3fb773b09?auto=format&fit=crop&q=80')] bg-cover opacity-[0.14] grayscale pointer-events-none" />
    <motion.div 
      initial={{ opacity: 0, y: -20 }}
      animate={isActive ? { opacity: 1, y: 0 } : {}}
      className="text-center mb-10 z-10"
    >
      <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#D2691E]/10 border border-[#D2691E]/20 text-[#F4A460] font-mono text-xs tracking-widest rounded-full uppercase mb-3">
        <Globe size={14} className="text-[#D2691E]" /> ТОГТВОРТОЙ ХӨГЖЛИЙН ЗОРИЛТУУД
      </div>
        ...
        >
          ...
          <div className="z-10">
            <div className="flex justify-between items-start mb-4">
              <span className={`text-5xl font-black ${card.accent} opacity-40 group-hover:opacity-100 transition-opacity`}>{card.goal}</span>
              <span className="text-[9px] font-mono tracking-wider bg-white/5 border border-white/10 px-2.5 py-1 rounded-full text-white/50">{card.kpi}</span>
            </div>
            <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#F4A460] transition-colors leading-snug">{card.title}</h3>
            <p className="text-[#F5DEB3]/70 text-xs leading-relaxed font-light">{card.desc}</p>
          </div>
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs font-mono text-[#F5DEB3]/60 tracking-wider">Монгол Улсын хөгжлийн бодлого Алсын Хараа 2050-тай холбогдсон</span>
      </div>
      <div className="hidden md:block w-px h-5 bg-white/10" />
      <div className="flex items-center gap-3">
        <span className="w-2.5 h-2.5 rounded-full bg-orange-500 animate-pulse" />
        <span className="text-xs font-mono text-[#F5DEB3]/60 tracking-wider">Оролцоо хамрах хүрээ: ЕРӨНХИЙ БОЛОВСРОЛЫН СУРГУУЛИУД</span>
      </div>
    </motion.div>
  </div>
);
...
const SIASlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80')] bg-cover opacity-[0.08] pointer-events-none" />
      ...
      >
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#D2691E]/20 hover:bg-[#D2691E]/30 text-[#F4A460] font-mono text-[10px] rounded-full uppercase tracking-widest border border-[#D2691E]/30 w-fit">
            <Compass className="animate-spin-slow" style={{ animationDuration: '20s' }} size={12} /> STUDENTS IN ACTION (SIA)
          </div>
          ...
          <p className="text-xs text-[#F5DEB3]/70 leading-relaxed font-light">
            SIA бол зөвхөн уриа лоозон биш, сургууль, залуучуудын оролцоог бодит эдийн засгийн цикл дээр суурилсан эко орчин болгон сэргээдэг үндэсний дүүрэн хөтөлбөр юм.
          </p>
        </div>

        <div className="space-y-3 pt-4 border-t border-white/5">
          <div className="text-[10px] uppercase tracking-widest text-[#F4A460] font-mono font-bold">Хөтөлбөрийн шууд өгөөж:</div>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={idx} className="bg-white/5 border border-white/10 p-3 rounded-xl hover:bg-black/30 hover:border-emerald-500/30 transition-all">
                <div className="text-xl font-black text-white">{item.num}</div>
                <div className="text-[9px] uppercase font-mono text-emerald-400 font-medium tracking-wide">{item.t}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {[
          {
            ...
            accent: "border-orange-500/20 hover:border-orange-500/40 bg-orange-950/10",
          ...
          >
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-[28px] font-black font-mono text-white/5 group-hover:text-white/10 transition-colors">{item.step}</span>
              </div>
              <h3 className="text-base font-bold text-white mb-2 uppercase tracking-wide group-hover:text-[#F4A460] transition-colors">{item.title}</h3>
              <p className="text-[11px] text-[#F5DEB3]/70 leading-relaxed font-light">{item.desc}</p>
            </div>
...
const SkillsSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80')] bg-cover opacity-[0.01] pointer-events-none" />
    <motion.div 
      initial={{ opacity: 0, y: -20 }}
      animate={isActive ? { opacity: 1, y: 0 } : {}}
      className="text-center mb-10 z-10"
    >
      <span className="bg-[#D2691E]/10 border border-[#D2691E]/20 text-[#F4A460] px-4 py-1.5 rounded-full text-xs font-mono tracking-widest uppercase mb-3 inline-block">ЧАДАВХЖУУЛАЛТ</span>
      <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-widest">
      ...
      {[
        {
          ...
          items: [
            { h: "Speaking", d: "Хэлэлцүүлэгт оролцох, бусадтай ойлголцох.", level: 85 },
            { h: "Writing", d: "Судалгааны тайлан, төслийн баримт бичиг.", level: 80 },
            { h: "Reading", d: "Академик судалгаа, материал унших чадвар.", level: 90 }
          ],
        ...
        },
        {
          ...
          items: [
            { h: "Судалгаа", d: "Байгаль орчны асуудлаар судалгаа хийх.", level: 95 },
            { h: "Шийдэл", d: "Тогтвортой хөгжлийн стратеги боловсруулах.", level: 75 },
            { h: "Санаачилга", d: "Ногоон практик хэрэгжүүлэх соёл.", level: 85 }
          ],
        ...
        },
        {
          ...
          items: [
            { h: "Илтгэх чадвар", d: "Тайзан дээр олон нийтийн өмнө танилцуулга.", level: 90 },
            { h: "Багаар ажиллах", d: "Хэлэлцүүлэгт манлайлж, хамтын шийдвэр.", level: 85 },
            { h: "Бусдад хүргэх", d: "Үзэл бодлоо зөвөөр ойлгуулж, хамтран зүтгэгч.", level: 88 }
          ],
        ...
        >
          <div>
            <h3 className="text-xl font-bold text-white mb-6 border-b border-white/5 pb-3 flex items-center justify-between">
              <span>{col.title}</span>
              <span className={`w-2 h-2 rounded-full ${col.accent.replace("text-", "bg-")}`} />
            </h3>
            <div className="space-y-4">
              {col.items.map((item, idx) => (
                <div key={idx} className="space-y-1.5">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-white font-bold uppercase tracking-wider font-mono">{item.h}</span>
                    <span className={`${col.accent} font-mono font-bold`}>{item.level}%</span>
                  </div>
                  ...
                  <p className="text-[10px] text-[#F5DEB3]/60 leading-relaxed font-light">{item.d}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {[
        {
          phase: "2027 ОН",
          title: "Анхны зорилт",
          body: "2027 он гэхэд 1,000 мод тарьсан байх хувийн болон хамтын ногоон төлөвлөгөө.",
        ...
        },
        {
          phase: "2050 ОН",
          title: "Эрс шинэчлэл",
          body: "Монголын цөлжилтийн 30%-ийг арилгах урт хугацааны стратегийн гол тулгуур зорилт.",
        ...
        >
          <div className="h-44 bg-black/45 relative overflow-hidden">
            ...
            <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md border border-white/10 p-2.5 rounded-2xl flex items-center gap-2">
              {card.icon}
              <span className="text-[10px] font-mono font-bold text-white uppercase tracking-wider">{card.phase}</span>
            </div>
          </div>
...
const FutureTasksSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&q=80')] bg-cover opacity-[0.14] pointer-events-none" />
    {/* Ambient lighting */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-5 mb-6">
            <div className="p-4 bg-gradient-to-br from-[#D2691E] to-[#CD853F] rounded-[1.25rem] text-white shadow-xl shadow-[#D2691E]/20">
              <RefreshCw size={28} className="animate-spin-[spin_10s_linear_infinite]" style={{ animationDuration: '12s' }} />
            </div>
            <div>
              <div className="text-[10px] text-[#F4A460] font-bold uppercase tracking-widest">Autonomous Loop</div>
              <h3 className="text-2xl font-black text-white uppercase tracking-tight">♻️ THE GREEN CYCLE</h3>
            </div>
          </div>
          
          <p className="text-base text-[#F5DEB3]/85 font-light leading-relaxed max-w-xl">
            Хуванцар хог хаягдлыг цуглуулан дахин боловсруулж (Recycle), борлуулсан орлогоор нь чацарганы болон бусад нэн хэрэгцээт модны суулгац худалдан авч тарина. Энэхүү цикл нь санхүүгийн болон байгаль орчны хувьд тасралтгүй, өөрөө өөрийгөө тэтгэх мөчлөг юм.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8 relative">
          {[
            { label: "Цуглуулах", desc: "Хуванцар хог хаягдал", icon: <Leaf size={16} className="text-sky-400" />, border: "border-sky-500/20", bg: "bg-sky-500/5" },
            { label: "Боловсруулах", desc: "Eco Recycle үйлдвэр", icon: <RefreshCw size={16} className="text-purple-400" />, border: "border-purple-500/20", bg: "bg-purple-500/5" },
            { label: "Борлуулах", desc: "Ногоон ашиг олох", icon: <ShoppingBag size={16} className="text-amber-400" />, border: "border-amber-500/20", bg: "bg-amber-500/5" },
            { label: "Мод Тарих", desc: "Чацарганаар сэргээх", icon: <Sprout size={16} className="text-emerald-400" />, border: "border-emerald-500/20", bg: "bg-emerald-500/5" }
          ].map((step, i) => (
            <div key={i} className="relative">
              <div className={`p-4 rounded-2xl border ${step.border} ${step.bg} flex flex-col justify-between h-28 group-hover:bg-white/[0.02] transition-colors`}>
                <div className="flex justify-between items-start">
                  <span className="text-[10px] font-mono text-[#F4A460]/75">0{i+1}</span>
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#F5DEB3]/50 line-clamp-1 mt-0.5">{step.desc}</p>
                </div>
              </div>
              {i < 3 && (
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="text-[10px] font-mono text-red-400 font-bold bg-red-500/10 px-2 py-0.5 rounded-full uppercase tracking-wider">Social Viral</span>
        </div>

        <div>
          <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-3">🎬 Reel Challenge</h3>
          <p className="text-sm text-[#F5DEB3]/70 font-light leading-relaxed">
            <span className="text-white font-bold text-red-400">"1 Follower = 1кг Хог цуглуулах"</span> уриалгыг сошиал тавцанд гарган бодит үйлдлээр вирал болгож, олон зуун залуусыг нийгмийн хариуцлагатай эко давалгаанд нэгтгэнэ.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between border-t border-white/5 pt-4">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-bold text-red-400 uppercase font-mono tracking-widest">LIVE TRACKING</span>
          </div>
          <span className="text-xs text-[#F5DEB3]/40 font-mono">Tik Tok & Reels</span>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="text-[10px] font-mono text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded-full uppercase tracking-wider">Major Target</span>
        </div>

        <div>
          <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-3">🌳 1000 Мод Тарих</h3>
          <p className="text-sm text-[#F5DEB3]/70 font-light leading-relaxed">
            Нийт <span className="text-white font-bold text-emerald-400">1,000 чацарганы болон орон нутагт дасан зохицох чадвартай моддийг</span> голлон суулгаж, хөрсний эвдрэл, элсний нүүлтийг бодитоор зогсоох экологийн хана үүсгэнэ.
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="w-full h-1.5 bg-black/40 rounded-full overflow-hidden p-[2px]">
            <div className="h-full bg-gradient-to-r from-[#D2691E] to-emerald-500 rounded-full animate-pulse" style={{ width: '100%' }} />
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="text-[10px] font-mono text-amber-400 font-bold bg-amber-500/10 px-2 py-0.5 rounded-full uppercase tracking-wider">Alliance</span>
        </div>

        <div>
          <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-3">🤝 Гэрээ байгуулах</h3>
          <p className="text-sm text-[#F5DEB3]/70 font-light leading-relaxed">
            Сургууль, сургалтын төв, албан байгууллагуудтай <span className="text-white font-bold text-amber-400">хамтын ажиллагааны Харилцан Ойлголцлын Санамж бичиг</span> үзэглэж, эко сүлжээг урт хугацаанд тогтвортой ажиллуулна.
          </p>
        </div>
      ...
      >
        ...
        <div className="text-[#F4A460] font-black text-5xl tracking-tight mb-1 font-mono">2026</div>
        <div className="text-xs text-white uppercase font-bold tracking-[0.2em]">НОГООН ЗОРИЛТ</div>
        <p className="text-[10px] text-[#F5DEB3]/60 max-w-[180px] mt-2 leading-relaxed">Монгол орны цөлжилт уур амьсгалын өөрчлөлтийн эсрэг бодит үйл хэрэг</p>
      </motion.div>
    </div>
  </div>
);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      >
        ...
        <p className="text-lg text-[#F5DEB3]/80 leading-relaxed font-light">
          Сургуулийн сурагчдад эко систем, ургамал зүйн үндэс, хог хаягдлын зөв ангиллын боловсролыг хувийн хурцадмал бус хөгжилтэй, тоглоомжсон дижитал орчинд олгоно.
        </p>
        
        <div className="space-y-3.5 pt-2">
          {[
            { t: "Интерактив диаграммууд", d: "Цөлжилт болон шим мандлын эко сүлжээ зургууд" },
            { t: "Тоглоомжуулсан сорил", d: "Ургамал тарьж, оноо цуглуулах виртуал туршилт" },
            { t: "Нээлттэй мэдээллийн сан", d: "Төслийн явц, залуусын идэвх зүтгэлийн нэгдсэн хяналт" }
          ].map((item, i) => (
            <div key={i} className="flex items-start gap-4 bg-white/[0.02] border border-white/5 px-5 py-3.5 rounded-2xl hover:bg-[#4CAF50]/10 hover:border-[#4CAF50]/20 transition-colors">
              <div className="w-10 h-10 bg-[#4CAF50]/15 rounded-xl flex items-center justify-center text-[#4CAF50] font-bold shrink-0">
                <Layout size={18} />
              </div>
              <div>
                <h4 className="text-sm font-bold text-white uppercase tracking-wide leading-tight">{item.t}</h4>
                <p className="text-xs text-[#F5DEB3]/60 mt-0.5 leading-relaxed">{item.d}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="relative z-10 bg-[#160d05]/95 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden aspect-[4/3] flex flex-col backdrop-blur-2xl">
          ...
          <div className="bg-white/[0.04] px-5 py-4 flex items-center gap-4 border-b border-white/5 shrink-0">
            ...
            <div className="bg-black/40 rounded-xl px-4 py-1.5 text-xs text-white/40 font-mono flex-1 flex items-center justify-between border border-white/5">
              ...
              <span className="text-[#4CAF50] text-[9px] font-bold tracking-widest bg-[#4CAF50]/10 px-2 py-0.5 rounded-md">SECURE SSL</span>
            </div>
          </div>
          ...
          <div className="p-6 flex-1 flex gap-4 bg-gradient-to-b from-[#140b04] to-[#121c13] overflow-hidden select-none relative">
            ...
            <div className="w-1/4 h-full border-r border-white/5 pr-4 flex flex-col gap-2 shrink-0">
              <div className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1 pl-2">Хичээлүүд</div>
              ...
              <div className="mt-auto p-3 bg-black/40 rounded-2xl border border-white/5 text-center">
                <div className="text-[10px] font-bold text-[#F4A460]">LEVEL 4 [ECOLOGIST]</div>
                <div className="text-xs font-black text-white mt-1">2,450 XP</div>
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-4 overflow-hidden relative">
              ...
              <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                <span className="text-[9px] font-mono text-[#4CAF50] bg-[#4CAF50]/10 px-2 py-0.5 rounded uppercase font-bold">Хүүхдэд зориулсан сорил</span>
                <h3 className="text-md font-black text-white mt-2 leading-none uppercase">ЦӨЛЖИЛИЙГ ШИЙДЭХ НЬ</h3>
                <p className="text-[10px] text-[#F5DEB3]/60 mt-1 lines-clamp-1">Элсний нүүдлийг ямар бүтэцтэй ургамал хамгийн сайн хазаарладаг вэ?</p>
              </div>
              ...
              <div className="bg-black/30 border border-white/5 rounded-2xl p-3 flex flex-col items-center justify-center min-h-[90px] relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 relative z-10">
                  <div className="flex flex-col items-center gap-0.5 scale-90">
                     ...
                     <span className="text-[8px] font-bold text-amber-400 font-mono">НАР</span>
                  </div>
                  <div className="text-[#4CAF50]/30 animate-pulse text-xs shrink-0 font-mono">──▶</div>
                  <div className="flex flex-col items-center gap-0.5 scale-90">
                     ...
                     <span className="text-[8px] font-bold text-emerald-400 font-mono">ЧАЦАРГАНА</span>
                  </div>
                  <div className="text-[#4CAF50]/30 animate-pulse text-xs shrink-0 font-mono">──▶</div>
                  <div className="flex flex-col items-center gap-0.5 scale-90">
                     ...
                     <span className="text-[8px] font-bold text-[#F4A460] font-mono">ХӨРС_СЭРГЭЭЛТ</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/35 rounded-2xl p-4 border border-white/5 space-y-2 relative">
                <div className="text-[9px] text-[#F5DEB3]/50 font-bold uppercase tracking-wider">Асуулт #12:</div>
                <div className="text-xs font-black text-white">Мод тарих нь элсний шороон шуургыг хэрхэн дарах вэ?</div>
                
                <div className="space-y-1.5 pt-1">
                  {/* Option A */}
                  <div className="flex items-center justify-between p-2 rounded-xl bg-white/[0.01] border border-white/5 text-[10px]">
                    <span className="text-white/60">A. Хөрсийг халааж, тэнгэр рүү уур амьсгалыг хөргөнө</span>
                  ...
                  <div className="flex items-center justify-between p-2 rounded-xl bg-[#4CAF50]/5 border border-[#4CAF50]/40 text-[10px] relative">
                    <span className="text-white font-black">B. Хөрсний үндсийг барьж, шороо урт болохоос сэргийлнэ</span>
                    <div className="w-3.5 h-3.5 rounded-full bg-[#4CAF50] flex items-center justify-center text-white text-[9px] font-bold">✓</div>
                    ...
                    <div className="absolute top-1/2 left-3/4 -translate-y-1/2 pointer-events-none">
                      <div className="w-12 h-12 bg-[#4CAF50]/20 rounded-full animate-ping absolute -top-6 -left-6" style={{ animationDuration: '2s' }} />
                    </div>
                  </div>
                </div>
              </div>
...
const MonthlyCompetitionsSlide = ({ isActive }: SlideProps) => {
  const comps = [
    { title: "Хог ангилалтын тэмцээн", desc: "Хамгийн зөв ангилсан анги шалгарна.", img: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80", label: "09 САР: Waste Classify" },
    { title: "Ус хэмнэлтийн сорил", desc: "7 хоногт хамгийн бага ус хэрэглэсэн анги шалгарна.", img: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", label: "10 САР: Hydro Smart" },
    { title: "Ногоон ангийн тэмцээн", desc: "Ангидаа ургамал тарьж, хамгийн сайн арчилсан анги шалгарна.", img: "https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?auto=format&fit=crop&q=80", label: "11 САР: Green Room" },
    { title: "Хог хаягдалгүй өдөр", desc: "Бүтэн долоо хоног хог хаягдалгүй байсан анги шалгарна.", img: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80", label: "02 САР: Zero Waste" },
    { title: "Хуванцраас татгалзах сорил", desc: "Нэг сарын хугацаанд хуванцар хэрэглээгээ хамгийн их бууруулсан анги шалгарна.", img: "https://images.unsplash.com/photo-1618477431435-08169135061b?auto=format&fit=crop&q=80", label: "03 САР: No Plastic" },
    { title: "Дахин боловсруулалтын бүтээлч тэмцээн", desc: "Хаягдал материалаар хамгийн гоё бүтээл хийсэн анги шалгарна.", img: "https://images.unsplash.com/photo-1536859355448-76f92ebdc33d?auto=format&fit=crop&q=80", label: "04 САР: Upcycle Art" },
  ];

  return (
    <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&q=80')] bg-fixed opacity-[0.01] grayscale" />
      <div className="text-center mb-10 relative z-10">
        <span className="bg-[#D2691E]/10 border border-[#D2691E]/20 text-[#F4A460] px-4 py-1.5 rounded-full text-xs font-mono tracking-widest uppercase mb-3 inline-block">ИДЭВХТЭЙ ОРОЛЦОО</span>
        <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-widest">
        ...
        {comps.map((comp, i) => (
          ...
          >
            <div className="absolute inset-0 opacity-40 group-hover:opacity-85 transition-all duration-700">
              <img src={comp.img} className="w-full h-full object-cover scale-105 group-hover:scale-100" alt={comp.title} />
            </div>
            ...
            <div className="z-10 flex justify-between items-start">
              ...
              <span className="text-[9px] font-mono text-[#F4A460]/40 group-hover:text-[#F4A460] transition-colors uppercase">ACTIVE ➔</span>
            </div>
...
const InternationalLevelSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[#0d0703]/95 z-0" />
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1451187534963-565868af21f6?auto=format&fit=crop&q=80')] bg-cover opacity-[0.02] pointer-events-none z-0" />
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-[0.03] pointer-events-none flex items-center justify-center z-0">
      <Globe size={600} />
    </div>

    <div className="text-center mb-8 relative z-10">
      <span className="bg-[#D2691E]/10 border border-[#D2691E]/20 text-[#F4A460] px-4 py-1.5 rounded-full text-xs font-mono tracking-widest uppercase mb-3 inline-block">ОЛОН УЛСЫН ТҮВШИН</span>
      <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-widest">
      ...
      <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-wider">Глобал Платформын тухай</h3>
          </div>
          <p className="text-[#F5DEB3]/75 text-xs leading-relaxed font-light">
            SIA (Students in Action) олон улсын тэмцээн нь дэлхийн өнцөг булан бүрийн залуу эко манлайлагчдыг нэгтгэж, улс дамнасан хамтын ажиллагааны гүүр болно.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-wider">Оролцогчдын Давуу Тал</h3>
          </div>
      ...
      <div className="lg:col-span-5">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-wider">Шат Дараалсан Замнал</h3>
          </div>
          <div className="space-y-4 flex-1 flex flex-col justify-center">
            {[
              { t: "Сургууль", d: "Дотоодын шалгаруулалт, анхан шатны төслүүд." },
              { t: "Аймаг / Хот", d: "Бүсийн шилдэг төслүүдийн уралдаан." },
              { t: "Үндэсний Түвшин", d: "Монгол улсын хэмжээн дэх шигшээ уулзалт." },
              { t: "Олон Улсын Тавцан", d: "НҮБ-аар баталгаажсан дэлхийн хуралдаан." }
            ].map((step, i) => (
              <div key={i} className="flex items-center gap-4 group">
                ...
                <div>
                  <h4 className="text-white font-bold text-xs uppercase tracking-wider">{step.t}</h4>
                  <p className="text-[10px] text-[#F5DEB3]/60 font-light">{step.d}</p>
                </div>
              </div>
            ))}
          </div>
...
const CausesSlide = ({ isActive }: SlideProps) => {
  const causes = [
    { icon: <ThermometerSun size={28} />, title: "Уур амьсгал", sub: "Global Warming", desc: "Дэлхийн температурын эрчимтэй өсөлт, хур тунадасны урт хугацааны хэт хомсдол." },
    { icon: <Trees size={28} />, title: "Ой мод огтлолт", sub: "Deforestation", desc: "Моддыг ихээр устгаж хөрсийг салхи, тунадасны хамгаалалтгүй болгон хатаах." },
    { icon: <Wind size={28} />, title: "Хэт бэлчээрлэлт", sub: "Overgrazing", desc: "Малын тоо толгой бэлчээрийн даацаас хэтэрч хөрсний ургамлан бүрхэвчийг талхлах." },
    { icon: <Droplets size={28} />, title: "Усны буруу хэрэглээ", sub: "Water Mismanagement", desc: "Гадаргын сувгуудын зохисгүй хэрэглээ, гүрний болон гүний усны хомсдол." },
    { icon: <AlertTriangle size={28} />, title: "Буруу тариалан", sub: "Soil Depletion", desc: "Хөрсийг тасралтгүй амралтгүй ашиглаж, үржил шимийг бүрэн алдагдуулах." }
  ];
    ...
    <div className="max-w-7xl mx-auto px-6 h-full flex flex-col justify-center relative">
        ...
        {causes.map((item, idx) => (
          ...
          >
            ...
            <div>
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tight mb-1">{item.title}</h3>
              <p className="text-[10px] text-orange-400/60 font-mono font-bold uppercase tracking-wider mb-3">{item.sub}</p>
            </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-mono text-white/50 uppercase">Нөлөөллийн харьцаа:</span>
        </div>
        <div className="flex flex-wrap gap-6 text-[11px] font-bold uppercase text-[#F5DEB3]/70 font-mono">
          <div>🔥 Цаг уурын шууд хүчин зүйл: <span className="text-orange-500 font-bold">13%</span></div>
          <div>🚜 Хүний буруутай үйл ажиллагаа: <span className="text-[#4CAF50] font-bold">87%</span></div>
        </div>
...
const SolutionsSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80')] bg-cover opacity-[0.14] pointer-events-none" />
    {/* Ambient lighting */}
    ...
    <div className="text-center mb-10 relative z-10">
      ...
      <h2 className="text-5xl font-black text-white uppercase tracking-tighter mt-3">
        ШИЙДЛҮҮД: <span className="text-emerald-400">БИД ЮУ ХИЙЖ ЧАДАХ ВЭ?</span>
      </h2>
      <div className="h-[2px] w-24 bg-gradient-to-r from-transparent via-emerald-500 to-transparent mx-auto mt-4" />
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
      {[
        { title: "Ойжуулалт", category: "ECO-RESTORATION", desc: "Цөлжилттэй бүсүүдэд олноор мод тарьж хөрсийг бэхжүүлэх, салхины хүчтэй нөлөөллийг зогсоох.", icon: <Leaf size={24} className="text-emerald-400" /> },
        { title: "Тогтвортой ХАА", category: "MANAGEMENT", desc: "Бэлчээрийн даацыг ухаалгаар зохицуулах, хөрсийг амраах, сэлгэж тариалах ухаалаг арга зүй.", icon: <ArrowRightLeft size={24} className="text-blue-400" /> },
        { title: "Усны хэмнэлт", category: "HYDRO-SYSTEMS", desc: "Говийн хөрсөнд тохиромжтой дуслын болон ухаалаг усалгааны дэвшилтэт хамгаалалтын систем.", icon: <Droplets size={24} className="text-[#F4A460]" /> },
        { title: "Эко Мэдлэг олгох", category: "ADVOCACY", desc: "Шинэ үеийнхэнд байгаль дэлхийгээ хамгаалах хандлага хэвшил олгож, экологийн боловсрол суулгах.", icon: <Globe size={24} className="text-sky-400" /> },
        { title: "Бодлого, хяналт", category: "REGULATION", desc: "Хууль эрх зүйн орчныг чангалж, мод бэлтгэл, бэлчээрийн доройтлыг төрийн хяналтаар журамлах.", icon: <AlertTriangle size={24} className="text-red-400" /> },
        { title: "Нөхөн сэргээлт", category: "RECLAMATION", desc: "Доройтсон газруудын экосистемийг байгалийн болон туслах механик аргуудаар сэргээн идэвхжүүлэх.", icon: <Wind size={24} className="text-purple-400" /> }
      ].map((item, i) => (
        <motion.div
          key={i}
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="text-[9px] text-emerald-400/60 font-mono font-bold uppercase tracking-wider block">{item.category}</span>
                <h3 className="text-lg font-black text-white uppercase tracking-tight group-hover:text-emerald-400 transition-colors">{item.title}</h3>
              </div>
            </div>
          ...
          <div className="pt-2 border-t border-white/5 flex justify-between items-center text-[9px] font-mono text-[#F5DEB3]/40">
            ...
            <span className="scale-x-0 group-hover:scale-x-100 transition-transform duration-300 transform origin-right text-[#4CAF50] font-bold">READY ➔</span>
          </div>
        </motion.div>
      ))}
    </div>
...
const SIADetailsSlide = ({ isActive }: SlideProps) => (
  <div className="h-full flex flex-col justify-center max-w-7xl mx-auto px-6 relative overflow-hidden">
    <div className="absolute top-0 left-0 w-full h-full opacity-[0.02] pointer-events-none overflow-hidden select-none">
      <div className="text-[25rem] font-black text-white absolute -top-40 -left-45">SIA</div>
    </div>
    
    <div className="text-center mb-10 relative z-10">
      <span className="bg-[#D2691E]/10 border border-[#D2691E]/20 px-4 py-1.5 rounded-full text-xs font-mono tracking-widest text-[#F4A460] inline-block mb-3">ХЭТИЙН ТӨРХ</span>
      <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-widest">
        STUDENTS IN <span className="text-[#F4A460]">ACTION</span>
      </h2>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
      {[
        { 
          title: "Алсын Хараа", 
          desc: "Залуучуудыг байгаль хамгаалах үйлсэд манлайлагч болгон бэлтгэж, улсын хэмжээнд байгаль орчны соёлыг шинэ шатанд гаргах.", 
          icon: <Star className="text-amber-400" size={24} />,
          bg: "bg-[#1C120B]/65 border-amber-500/20",
          target: "МОНГОЛ ОРОН ДАЯАР"
        },
        { 
          title: "Үйл Ажиллагаа", 
          desc: "Үндэсний хэмжээнд хуванцар дахин боловсруулах сорил явуулах ба чадавхжуулах сургалтуудыг тогтмол зохион байгуулах.", 
          icon: <ListChecks className="text-emerald-400" size={24} />,
          bg: "bg-[#121A12]/65 border-emerald-500/20",
          target: "САР БҮРИЙН ТЭМЦЭЭН"
        },
        { 
          title: "Эцсийн Үр Дүн", 
          desc: "Тогтвортой хөгжлийн бодлогод оюутнуудын дуу хоолойг баттай шигтгэж, цөлжилт-бууруулалтын практик шийдлүүдийг үлдээх.", 
          icon: <Trophy className="text-sky-400" size={24} />,
          bg: "bg-[#11161B]/65 border-sky-500/20",
          target: "УЛСЫН ТАВЦАНД"
        }
      ].map((item, i) => (
        <motion.div
          key={i}
          ...
          animate={isActive ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: i * 0.15, type: "spring", stiffness: 90 }}
          className={`${item.bg} border-2 p-8 rounded-[2.5rem] backdrop-blur-md hover:scale-[1.02] transition-all duration-300 flex flex-col justify-between h-[300px]`}
        >
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[9px] font-mono font-bold tracking-widest text-[#F5DEB3]/30">{item.target}</span>
            </div>
            <h3 className="text-xl font-bold text-white mb-3 tracking-wider">{item.title}</h3>
            <p className="text-xs text-[#F5DEB3]/75 leading-relaxed font-light">{item.desc}</p>
          </div>
          <div className="text-[9px] font-mono tracking-widest text-white/30 text-right uppercase">
            SIA ➔ PHASE 0{i + 1}
          </div>
        </motion.div>
      ))}
...
class AmbientAudioEngine {
  ...
  public start() {
    ...
    try {
      ...
      this.mainGain.gain.linearRampToValueAtTime(0.40, this.ctx.currentTime + 3.0);
      this.isPlaying = true;
    } catch (e) {
  ...
  private swell(gainNode: GainNode, delay: number) {
    ...
    gainNode.gain.linearRampToValueAtTime(0.02 + Math.random() * 0.03, now + delay + swellLength * 0.4);
...
const slideMeta = [
  ...
  { title: "Багийн хамт олон", desc: "Хамтран зүтгэгч соён гэгээрүүлэгч залуус", icon: "👥" },
  { title: "Төслийн үндсэн чиглэл", desc: "Сургууль, хүнс, судалгаа, нөлөөллийн ажил", icon: "🎯" },
  { title: "Үндсэн асуудлууд", desc: "Аюулт цөлжилт болон хөрсний элэгдэл", icon: "🌋" },
  { title: "Шалтгаант нөлөө", desc: "Байгалийн хүчин зүйлс ба хүний үйл ажиллагаа", icon: "⚠️" },
  { title: "Хэтийн зорилго", desc: "Хуванцрын дахин боловсруулалт ба ойжуулалт", icon: "⛳" },
  { title: "Боломжит шийдэл", desc: "Экологийн цогц тактик, урт хугацааны үр дүн", icon: "💡" },
  { title: "Тогтвортой хөгжил (SDG 15)", desc: "Хуурай газрын экосистемийг хамгаалах сүлжээ", icon: "🌍" },
  { title: "Төлөвлөгөөт үйл ажиллагаа", desc: "Соён гэгээрүүлэх сургалт ба бодит ургацууд", icon: "📝" },
  { title: "Харьцуулсан харах цонх", desc: "Тал нутгийн доройтлын дүн шинжилгээ", icon: "📊" },
  { title: "SIA шинжилгээ", desc: "Нийгэм ба эдийн засагт үзүүлэх нөлөөллийн үнэлгээ", icon: "🔬" },
  { title: "SIA дэлгэрэнгүй", desc: "Соёл, эрүүлийн эрсдэлүүдийг үгүй хийх хасалт", icon: "🕵️" },
  { title: "Залуусын чуулган", desc: "Хуванцар цуглуулалтын цогц тогтвортой мөчлөг", icon: "🤝" },
  { title: "Эзэмшсэн ур чадвар", desc: "Олж авсан байгалийн халамж ба урам зориг", icon: "🎓" },
  { title: "Төслийн өргөжин тэлэлт", desc: "Сайжруулан дарах ухаалаг схемийн урсгал", icon: "✈️" },
  { title: "Ирээдүйн алхмууд", desc: "Эхний 5 жилийн дараалсан үр дүнтэй үйлсүүд", icon: "🚀" },
  { title: "Эко Академи", desc: "Багачуудын оюунд ногоон сэтгэлгээг суулгах ая", icon: "🏫" },
  { title: "Уралдаан тэмцээнүүд", desc: "Сургууль даяарх сар бүрийн бүтээлч сорилтууд", icon: "🏆" },
  { title: "Идэвхжүүлэх шагналын сан", desc: "Урам зориг өгөх, шилдэг ангиудыг шагнах систем", icon: "🎁" },
  { title: "Олон улсын жишиг загвар", desc: "Ногоон Хэрэм ба Сахелийн сургамжит арга замууд", icon: "🌐" },
  { title: "Санхүүжилт төсөв", desc: "Нийт төсвийн хуваарилалт, боломжууд", icon: "💰" },
  { title: "Алсын хараа", desc: "Эхний 20 жилийн стратеги төлөвлөгөө", icon: "🔭" },
  { title: "Сэрэмжлүүлэг анхааруулга", desc: "Бид засаж чадах хамтын хариуцлагатай ирээдүй", icon: "🚨" },
  { title: "Төгсгөлийн дүгнэлт", desc: "Ногоон цагариг сүлжээг хамтдаа цогцлооё", icon: "🌟" }
];
...
export default function App() {
  ...
  const handleContainerClick = (e: MouseEvent<HTMLDivElement>) => {
    ...
    if (target.closest('button') || target.closest('a') || target.closest('input') || target.closest('[role="button"]') || target.closest('.pointer-events-auto')) {
      return;
    }
              ...
              <div className="space-y-6 flex-1 flex flex-col min-h-0">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-md font-black text-white tracking-widest uppercase">СЛАЙД СҮЛЖЭЭ</h4>
                      <p className="text-[10px] font-mono text-[#F4A460]/60 uppercase tracking-widest">Interactive HUD Index</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => setIsMenuOpen(false)}
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-center">
                            <span className={`text-xs font-black uppercase tracking-wider group-hover/btn:text-orange-400 transition-colors ${currentSlide === item.index ? 'text-orange-400' : 'text-white'}`}>
                              {item.title}
                            </span>
